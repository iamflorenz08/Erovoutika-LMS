      ...
      <div className="bg-gray bg-opacity-20 w-full flex flex-wrap text-2xl items-center gap-5 p-1 text-gray">
        ...
        <div className="flex gap-1">
          <button
            type="button"
            className={`${
              editor?.isActive({ textAlign: "left" }) && "text-black"
            } p-2`}
          ...
          <button
            type="button"
            className={`${
              editor?.isActive({ textAlign: "center" }) && "text-black"
            } p-2`}
          ...
          <button
            type="button"
            className={`${
              editor?.isActive({ textAlign: "right" }) && "text-black"
            } p-2`}
