...
const ToDoListContainer = () => {
  return (
    <div
      className="flex flex-col h-[400px] bg-white rounded-lg border border-gray border-opacity-20">
      ...
      <div className='flex flex-col gap-4 h-full overflow-auto'>
        <label htmlFor="listOne" className="flex items-center gap-9 hover:bg-slate-100 px-4 py-1 cursor-pointer duration-300">
