...
const getPost = async (accessToken: string | undefined, postID: string, userId: string | any) => {
    const res = await fetch(`${process.env.API_URI}/api/v1/posts/${postID}${userId ? '?userId=' + userId : ''}`, {
        headers: {
